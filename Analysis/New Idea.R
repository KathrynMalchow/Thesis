...
#collect dfs that contain most frequent (top 5) collocations of df - cannot make function because order of key words matters
...
write.table(dm_1, 'C:/Users/Kathryn/Desktop/Master_Thesis/Thesis_Analysis/Analysis/dm_1.txt', col.names=TRUE, row.names = FALSE)
...
dm_1_scored = read.table(file = 'C:/Users/Kathryn/Desktop/Master_Thesis/Thesis_Analysis/Analysis/dm_1_comb+results.txt', sep="\t", quote="", comment.char="")
...
# make into .txt file
write.table(dm_2, 'C:/Users/Kathryn/Desktop/Master_Thesis/Thesis_Analysis/Analysis/dm_2.txt', col.names=TRUE, row.names = FALSE)

# back into df
dm_2_scored = read.table(file = 'C:/Users/Kathryn/Desktop/Master_Thesis/Thesis_Analysis/Analysis/dm_2+results.txt', sep="\t", quote="", comment.char="")
...
# make into .txt file
write.table(dm_3, 'C:/Users/Kathryn/Desktop/Master_Thesis/Thesis_Analysis/Analysis/dm_3.txt', col.names=TRUE, row.names = FALSE)

# back into df
dm_3_scored = read.table(file = 'C:/Users/Kathryn/Desktop/Master_Thesis/Thesis_Analysis/Analysis/dm_3+results.txt', sep="\t", quote="", comment.char="")
...
# make into .txt file
write.table(dm_4, 'C:/Users/Kathryn/Desktop/Master_Thesis/Thesis_Analysis/Analysis/dm_4.txt', col.names=TRUE, row.names = FALSE)

# back into df
dm_4_scored = read.table(file = 'C:/Users/Kathryn/Desktop/Master_Thesis/Thesis_Analysis/Analysis/dm_4+results.txt', sep="\t", quote="", comment.char="")
...
# make into .txt file
write.table(dm_5, 'C:/Users/Kathryn/Desktop/Master_Thesis/Thesis_Analysis/Analysis/dm_5.txt', col.names=TRUE, row.names = FALSE)

# back into df
dm_5_scored = read.table(file = 'C:/Users/Kathryn/Desktop/Master_Thesis/Thesis_Analysis/Analysis/dm_5+results.txt', sep="\t", quote="", comment.char="")
